...
<nav>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<h2 class="text-center text-lowercase m-5">Editar Cliente</h2>
...
<div class="form-group row">
	...
	<div class="col-md-7">
		<input type="text" class="form-control" name="cliente" value="<?php echo $datos[0]["cliente"];?>" >
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-7">
		<input type="text" class="form-control" name="contacto" value="<?php echo $datos[0]["contacto"];?>">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-7">
		<input type="text" class="form-control" name="rut" value="<?php echo $datos[0]["rut"];?>">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-7">
		<input type="text" class="form-control" name="giro" value="<?php echo $datos[0]["giro"];?>">
	</div>
</div>

<input type="hidden" name="grabar" value="si">
<input type="hidden" name="id" value="<?php echo $_GET["id"];?>">
<input type="submit" class="btn btn-success" value="Editar Cliente" title="Editar Cliente">
</form>
	</div>
